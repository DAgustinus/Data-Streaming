...
TOPIC_NAME = "lesson4.exercise6.click_events"
...
def produce():
    ...
    # Set content type to avro and accept data from JSON when we produce it
    # See: https://docs.confluent.io/current/kafka-rest/api.html#content-types
    headers = {
        "Content-Type": "application/vnd.kafka.avro.v2+json"
    }

    # Set the avro schema at the very top of data, and dict records in records key

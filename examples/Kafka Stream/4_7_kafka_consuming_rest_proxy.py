...
async def consume():
    ...
    consumer_name = "solution_consumer"

    # PART 1: Create the REST proxy consumer
    ...
    # PART 2: Subscribe to the REST proxy consumer
    ...
    # PART 3: Consume data using while loop REST proxy
    while True:
        ...
        # We can replace this to push data into DB or simply

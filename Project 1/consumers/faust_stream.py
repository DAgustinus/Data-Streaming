...
out_topic = app.topic("org.cta.chicago.stations.v2", partitions=1, value_type=TransformedStation)
# TODO: Define a Faust Table
table = app.Table(
   "org.cta.chicago.stations.v2",
...
async def process(events):
    async for event in events:
        ...
        logger.info("Stations data has been transformed")
